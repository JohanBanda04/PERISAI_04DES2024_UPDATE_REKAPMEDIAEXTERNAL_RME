        ...
        <div class="container-xl">
            <div class="row">
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('cetakrekapmediaexternal') }}" id="frmLaporanBerita"
                                  name="frmLaporanBerita"
                                  target="_blank"
                                  method="post">
                                @csrf
                                <div class="row">
    ...
    <script>
        $(function () {
            ...
            $('#frmLaporanBerita').submit(function () {
                ...
                var kode_divisi_pilihan = $('#frmLaporanBerita').find('#kode_divisi_pilihan').val();
                if (dari == "") {
                    Swal.fire({
                        title: 'Warning!',
