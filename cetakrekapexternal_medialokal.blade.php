        ...
        <tr>
            ...
            <td>
                ...
                @php
                    ...
                    } else if($kode_divisi_pilihan=="berita_umum"){
                        $jenis_berita = "Berita Umum";
                    } else {
                        $get_divisi_name = DB::table('divisi')->where("kode_divisi",$kode_divisi_pilihan)->first()->nama_divisi;
                        $jenis_berita = "Berita ".$get_divisi_name;
                    }
                @endphp
                <center>
                    <span id="title">
        ...
        <div class="col-12">
            ...
            margin-right: auto;">
                        ...
                        <tr style="">
                            ...
                            <th style="width: auto" rowspan="1" colspan="1">Tgl Beritaz</th>
